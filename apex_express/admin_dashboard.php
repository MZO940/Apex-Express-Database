            ...
            <div class="dashboard-central-holder">
                ...
                <?php } elseif ($view === 'add_parcel') { ?>
                    ...
                    <form method="POST" class="brand-engineered-form expanded-manifest-form">
                        ...
                        <input type="text" name="tracking_id" placeholder="Unique Consignment Tracking ID (e.g. APX-2026-XYZ)"
                            required>
                        ...
                        <button type="submit" name="save_parcel_complete" class="btn-form-commit btn-accent-commit">Compile and
                            Deploy Shipment</button>
                    </form>
                <?php } ?>
    ...
    <footer class="footer">
        <div class="footer-container">
            ...
            <div class="footer-col">
                ...
                <div class="social-links">
                    <a href="https://business.linkedin.com/"><img src="linkedin.png" class="social-icon"></a>
                    <a href="https://web.facebook.com/"><img src="facebook-app-symbol.png" class="social-icon"></a>
        ...
        <div class="footer-bottom">
            <div class="bottom-content">
                ...
                <p>@ 1983 - 2026 Apex Express Logistics. All rights
                    reserved.</p>
